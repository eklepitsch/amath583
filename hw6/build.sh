...
nvcc -c -arch sm_50 -std=c++14 -I$INCLUDE_DIR -I/usr/local/include -I/usr/local/cuda-12.1/include $SRC_DIR/gradient-fftw.cpp
nvcc -o $BUILD_DIR/xgrad-fftw gradient-fftw.o -L/usr/local/lib -lfftw3 -L/usr/local/cuda-12.1/lib64 -lcudart -lcufft -lm
